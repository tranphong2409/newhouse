...
if($hashValidated=="CORRECT" && $txnResponseCode=="0"){
	...
	header('Location: http://demo31.ninavietnam.org/anphuoc/xac-nhan-thanh-cong.html?mahoadon='.$merchTxnRef);
}elseif ($hashValidated=="INVALID HASH" && $txnResponseCode=="0"){
	$transStatus = "Giao dịch Pendding";
}else {
	$transStatus = "Giao dịch thất bại";
	header('Location: http://demo31.ninavietnam.org/anphuoc/xac-nhan-khong-thanh-cong-noi-dia/'.$txnResponseCode);
