...
$config['Database']['dbname'] = 'batdongstt_forum';
...
$config['Database']['technicalemail'] = 'linhnguyennina@gmail.com';
...
$config['MasterServer']['username'] = 'batdongstt_forum';
$config['MasterServer']['password'] = 'pVADjJ8BvP';
