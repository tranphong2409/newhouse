<?php
	...
	$d->reset();
	$sql_quangcaol = "select * from #_doitac2 where hienthi=1 order by stt,id desc";
...
<head>
    ...
    <meta name="description" content="<?=$keyword_bar?>" />
    <meta name="keywords" content="<?=$description_bar?>" />
...
<body>
    <div class="header">
        ...
        <a class="reference" href="../" target="_self">Trang chủ</a>
    </div>
    <div class="wall">
        <div id="pg_container" class="pg_container">
            <ul id="pg_photos" class="pg_photos">
                ...
                <li><a href="#<?=$i+1?>">
                    <img src="../<?=_upload_doitac_l.$catalogue[$i]['photo']?>" alt="Catalogue <?=$i+1?>" /></a></li>
               <?php } ?>
    ...
    <div class="footer">
        <a class="back left" href="http://thapkim07.com"><strong>Cơ Khí Thuận Tiến</strong></a>
        <div class="thumbnailSlider" id="thumbnailSlider">
            <ul class="ts_container">
            <?php for($i=0;$i<count($catalogue);$i++){?>
                <li><a href="#<?=$i+1?>">Image <?=$i+1?></a></li>
            <?php } ?>
                ...
                <li class="ts_thumbnails">
                    <div class="ts_preview_wrapper">
                        ...
                        <?php for($i=0;$i<count($catalogue);$i++){?>
                            <li>
                                <img src="../<?=_upload_doitac_l.$catalogue[$i]['thumb']?>" width="75" height="75" alt="Thumb <?=$i+1?>" /></li>
                        <?php } ?>
        ...
        <a class="back right" href="http://www.nina.vn" target="_blank" title="Thiết kế web">
            Thiết kế web NinaCo ltd</a>
    </div>
