...
<?php
  ...
  {
  	global $item;
    $sql="select * from table_baiviet where hienthi=1 and type='".$_GET['type']."' order by stt asc";
    //echo $sql;exit();
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=albumproduct&act=add<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm <?=$title_main?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=albumproduct&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
       ...
       <?php /* <?php if($config_images=="true"){?>
		...
		<div class="formRow">
	      	...
	      	<div class="formRight">
	      		<div class="note">Kích thước - width : <?php echo _width_thumb*$ratio_;?> px , Height : <?php echo _height_thumb*$ratio_;?> px </div>
			    <div class="clear"></div>
    ...
    <div class="widget">
    	<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=albumproduct&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
    </div>
