<?php
      ...
      $d->reset();
      $sql = "SELECT COUNT(*) as num FROM #_booking where view=0 ";
      $d->query($sql);
            ...
            <ul>
                ...
                <li class="ddnew"><a title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Thông báo</span><span class="numberTop"><?=$tong_count?></span></a>
                    <ul class="userMessage">
                        ...
                        <li><a href="index.php?com=booking&act=man" title="" class="sInbox"><span>Nhu cầu KH</span> <span class="numberTop" style="float:none; display:inline-block"><?=$row_giohang['num']?></span></a></li>
