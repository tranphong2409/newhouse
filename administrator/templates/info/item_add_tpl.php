		      ...
		      <?php if(count($ds_photo)!=0){?>       
		            <?php for($i=0;$i<count($ds_photo);$i++){?>
		              <div class="item_trich">
		                  <img class="img_trich" width="140" height="110" src="<?=_upload_baiviet.$ds_photo[$i]['photo']?>" />
...
<?php } ?>
	...
	<?php if($config_mota=='true'){ ?>
		<div class="formRow lang_hidden lang_vi active">
			<label>Mô tả</label>
			<div class="ck_editor">
                <textarea id="mota_vi" title="Nhập mô tả . " class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow lang_hidden lang_en">
			...
			<div class="ck_editor">
                <textarea id="mota_en" title="Nhập mô tả . " class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
