 ...
 function get_phongtamd()
  {
    ...
    {
      if($row["id"]==(int)@$dangtin_detail["phongtam"])
        $selected="selected";
      else 
        $selected="";
...
function get_dientichd()
  {
    ...
    while ($row=@mysql_fetch_array($stmt)) 
    {
      if($row["id"]==(int)@$dangtin_detail["id_dientich"])
        $selected="selected";
      else 
        $selected="";
      $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';      
  ...
  function get_phongngud()
  {
    ...
    while ($row=@mysql_fetch_array($stmt)) 
    {
      if($row["id"]==(int)@$dangtin_detail["sophong"])
        $selected="selected";
      else 
        $selected="";
      $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';      
...
function get_phaplyd()
  {
    ...
    while ($row=@mysql_fetch_array($stmt)) 
    {
      if($row["id"]==(int)@$dangtin_detail["id_phaply"])
        $selected="selected";
      else 
        $selected="";
      $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';      
  ...
  function get_loaidatd()
  {
    ...
    while ($row=@mysql_fetch_array($stmt)) 
    {
      if($row["id"]==(int)@$dangtin_detail["id_loaidat"])
        $selected="selected";
      else 
        $selected="";
      $str.='<option value="'.$row["id"].'" '.$selected.'>'.$row["ten_vi"].'</option>';      
   ...
   function get_huongdatd()
  {
    ...
    while ($row=@mysql_fetch_array($stmt)) 
    {
      if($row["id"]==(int)@$dangtin_detail["id_huong"])
        $selected="selected";
      else 
        $selected="";
      $str.='<option value='.$row["id"].' '.$selected.'>'.$row["ten_vi"].'</option>';      
    ...
    <div class="noidung_detail">
            ...
            <div class="wrap-address">  
                    ...
                    <div class="row-field">
                            ...
                            <div class="field-content1">
                                <input placeHolder="Nhập diện tích" required  name="dientich" type="text" value="<?=($_POST['dientich']=='')?$dangtin_detail['dientich']:$_POST['dientich']?>" id="dientich">
...
<div class="row-field" style="padding-right:0px;" >
                            <div class="left_select">
                                <p>Số tầng(<span>*</span>)</p>
                            </div>
                            <div class="field-content1">
                                <input placeHolder="Nhập số tầng" required  name="sotang" type="text" value="<?=($_POST['sotang']=='')?$dangtin_detail['sotang']:$_POST['sotang']?>" id="sotang">
...
<div class="row-field">
                        ...
                        <div class="field-content1">
                            <input placeHolder="Nhập giá" required name="gia" type="text" value="<?=($_POST['gia']=='')?$dangtin_detail['giaban']:$_POST['gia']?>" id="gia">
...
<?php if($dangtin_detail['type']=='duan'){ ?>
    <div class="clear"></div>
    <div class="title_info">
...
<input type="hidden" name="type" value="<?= $dangtin_detail['type'] ?>" />
    </form>
</div>
...
<style>
    ...
    .map-edit {width: 100%;height: 350px; border: 1px solid #BBBBBB; overflow:hidden !important;}
