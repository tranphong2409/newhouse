...
<div id="sanpham">
    ...
    <div class="title_tt"><h2><?=$title_detail?></h2></div><div class="clear" style="height:10px;"></div>

            <?php if(count($album_images)<=0) { ?><div class="updating"><?=_khongcohinh?></div><?php }else{ ?>
    		   <div id="gallery-wrap">
