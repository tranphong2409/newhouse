...
<div class="dkdn_box">
    <form method="post" name="frmdoimatkhau" action="doi-mat-khau.html" id="frmdoimatkhau" enctype="multipart/form-data">
       ...
       <tr>
            ...
            <td class="col2">
              <div class="box_input hover_box">
               <i class="fa fa-key"></i>
                <input name="password" type="password" id="password" class="input hover_box" value="<?=$_POST["password"]?>" required minlength="6" placeholder="<?=_matkhau?>" />
              </div>
